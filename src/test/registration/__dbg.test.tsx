...
describe("driver registration (e2e)", () => {
  ...
  it("submits a complete application and redirects to the driver dashboard", async () => {
    ...
    console.log("DBG insert calls:", insert.mock.calls.length);
    console.log("DBG errors:", JSON.stringify(Array.from(document.querySelectorAll(".text-destructive")).map((e) => e.textContent)));
