...
const tourSteps: TourStep[] = [
  {
    id: 'welcome',
    title: 'Welcome to IoT Support',
    description: 'This dashboard helps you manage IoT device installations and maintenance tasks. Track installations, perform maintenance, and ensure devices are functioning properly across your assigned city.',
    icon: Cpu,
    position: 'center',
  },
  {
  ...
  },
  {
    ...
    description: 'Search by device serial number, IMEI, vehicle plate, or location to find specific tasks.',
  ...
  },
  {
    ...
    description: 'View all IoT tasks in your assigned city. Tasks include device details, SIM provisioning info, vehicle data, and installation addresses.',
  ...
  },
  {
    ...
    description: 'Each task includes the installation address. Use this to plan your route efficiently across multiple appointments.',
    icon: MapPin,
    position: 'center',
  },
  {
    ...
    description: 'Tasks can have scheduled dates and times. Check these to ensure you arrive on time and coordinate with vehicle owners.',
    icon: Calendar,
    position: 'center',
  },
  {
    id: 'feedback',
    title: 'Report Issues',
    description: 'Use the feedback feature to report problems, note SIM activation issues, flag equipment defects, or document special circumstances.',
    icon: MessageSquare,
    position: 'center',
  },
  {
    ...
    description: 'You\'re all set to manage IoT installations. Remember, you\'ll only see tasks in your assigned city. All activity is logged for audit and tracking.',
    icon: CheckCircle,
    position: 'center',
  },
];
